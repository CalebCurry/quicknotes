...
export default function Dropdown({value, onChange}: Props) {
    ...
    <div>
        ...
        ></CreatableSelect>
        { value && <button className="btn btn-ok ml-2" onClick={() => {
      ...
      <Dialog open={showModal} onClose={setShowModal} className="relative z-10">
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            { JSON.stringify(editValue) !== JSON.stringify(editValueOriginal) && <button className="btn btn-ok mx-1 px-3 py-2" onClick={async () => {
                    try {
                ...
                <button className="btn-ok mx-1 px-3 py-2" onClick={() => {setShowModal(false)}}>Cancel</button>
                <button className="btn-bad mx-1 px-3 py-2" onClick={async () => {
                    try {
